...
export default function MedicalStore() {
  const MedicalStoreData = [
    { id: 1, name: "HealthPlus Pharmacy", uri: require("../assets/NearbyMedical/Store1.webp") },
    { id: 2, name: "CityCare Medical", uri: require("../assets/NearbyMedical/Store2.webp") },
    { id: 3, name: "Wellness Drugs", uri: require("../assets/NearbyMedical/Store3.webp") },
    { id: 4, name: "MediTrust Pharmacy", uri: require("../assets/NearbyMedical/Store4.webp") },
  ];
